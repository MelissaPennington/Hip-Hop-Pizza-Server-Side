# Generated by Django 4.1.3 on 2024-01-15 21:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='hiphopapi.order')),
            ],
        ),
        migrations.AddField(
            model_name='order',
